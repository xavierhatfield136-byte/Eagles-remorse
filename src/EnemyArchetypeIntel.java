...
public final class EnemyArchetypeIntel {
    ...
    public static String archetypeLabel(ShipRole role) {
        ...
        return switch (role) {
            ...
            case PD_CRAFT -> "Point-Defense Craft";
            case DRONE -> "Swarm Drone";
            ...
            case MEDIUM_CRUISER, CRUISER -> "Assault Cruiser";
    ...
    public static String counterHint(ShipRole role) {
        ...
        return switch (role) {
            ...
            case PD_CRAFT -> "Use direct gun DPS; missiles are inefficient.";
            case DRONE -> "Use fast guns; avoid missile overcommit.";
            ...
            case MEDIUM_CRUISER, CRUISER -> "Clear escorts first, then dump missiles.";
