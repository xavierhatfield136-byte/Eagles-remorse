...
public final class FactionAttackCommitmentSystem {
    ...
    public enum Phase { PLANNED, STAGING, ACTIVE, HOLD, RESOLVING, COOLDOWN, COMPLETE, ABORTED, EXPIRED }
    ...
    public static final class Commitment {
        ...
        public boolean occupiesSlot() {
            return !released && phase != Phase.COMPLETE && phase != Phase.ABORTED && phase != Phase.EXPIRED;
        }
    }
    ...
    public static boolean setPhase(State state, String operationId, Phase phase) {
        ...
        if (phase == Phase.COMPLETE || phase == Phase.ABORTED || phase == Phase.EXPIRED) return false;
