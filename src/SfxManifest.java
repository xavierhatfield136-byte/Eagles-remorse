...
public final class SfxManifest {
    ...
    private static final List<EventSpec> EVENTS = List.of(
            ...
            event("super.blue.charge", "weapons", "super_blue_charge", Category.WEAPON, 3, 10.00, -10.0, 1, true),
            event("super.blue.fire", "weapons", "super_blue_fire", Category.WEAPON, 3, 0.90, -9.0, 1, true),
            event("hyper.blue.charge", "weapons", "hyper_blue_charge", Category.WEAPON, 3, 10.00, -9.5, 1, true),
            event("hyper.blue.fire", "weapons", "hyper_blue_fire", Category.WEAPON, 3, 0.90, -8.8, 1, true),
            event("super.red.charge", "weapons", "super_red_charge", Category.WEAPON, 3, 10.00, -10.0, 1, true),
            event("super.red.fire", "weapons", "super_red_fire", Category.WEAPON, 3, 0.90, -9.0, 1, true),
            event("hyper.red.charge", "weapons", "hyper_red_charge", Category.WEAPON, 3, 10.00, -9.5, 1, true),
            event("hyper.red.fire", "weapons", "hyper_red_fire", Category.WEAPON, 3, 0.90, -8.8, 1, true),
            event("super.green.charge", "weapons", "super_green_charge", Category.WEAPON, 3, 10.00, -10.0, 1, true),
            event("super.green.fire", "weapons", "super_green_fire", Category.WEAPON, 3, 0.90, -9.0, 1, true),
            event("hyper.green.charge", "weapons", "hyper_green_charge", Category.WEAPON, 3, 10.00, -9.5, 1, true),
            event("hyper.green.fire", "weapons", "hyper_green_fire", Category.WEAPON, 3, 0.90, -8.8, 1, true),
            event("super.yellow.charge", "weapons", "super_yellow_charge", Category.WEAPON, 3, 10.00, -10.0, 1, true),
            event("super.yellow.fire", "weapons", "super_yellow_fire", Category.WEAPON, 3, 0.90, -9.0, 1, true),
            event("hyper.yellow.charge", "weapons", "hyper_yellow_charge", Category.WEAPON, 3, 10.00, -9.5, 1, true),
